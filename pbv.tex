...
% She returns the disturbing scrap of paper to Glin and takes up her embroidery.
...
``When I speak with you I can't help thinking about~old times{\ldots}is there{\ldots}\linebreak[0]any word about{\ldots}Rimat?''
...
``Pale blue flowers bloom very early in the morning for one hour only,''
Aera chimes in.
...
``very early in the morning, for one hour only, for one week only\ldots''
...
% It's obvious to Bonimi that his aide said `spend' instead of `waste'.
...
Baby smacks his lips. Zakod replaces the vitamin bottle in Dela's hand with the feeding bottle.
